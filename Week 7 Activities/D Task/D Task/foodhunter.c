...
void draw_food(SDL_Renderer *renderer, Food *food_array, SDL_Texture *texture_smoke)
{
...
void add_or_move_food(SDL_Renderer *renderer, Food *food_array, SDL_Texture **texture_food, SDL_Texture *texture_smoke, int *food_index)
{
    // Move food logic
...
int main(int argc, char **argv)
{
    ...
    while (!quit)
    {
        ...
        // Application logic
        add_or_move_food(renderer, food_array, texture_food, texture_smoke, &food_renewal_idx);
        ...
        // Draw Food
        draw_food(renderer, food_array, texture_smoke);
